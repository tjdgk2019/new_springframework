            ...
            <table algin="center">
               <tr>
                  ...
                  <td><input type="text" id="title" class="form-control"
                     value="{board.boardTitle}" name="boardTitle" required></td>
               </tr>
               <tr>
                  <th><label for="writer">작성자</label></th>
                  <td><input type="text" id="writer" class="form-control"
                     value="{board.boardWriter}" name="boardWriter" readonly></td>
               </tr>
               <tr>
                  <th><label for="upfile">첨부파일</label></th>
                  <td><input type="file" id="upfile"
                     class="form-control-file border" name="reupFile"> 
               ...
               <tr>
                  ...
                  <td><textarea id="content" class="form-control" rows="10"
                        style="resize: none;" name="boardContent" required>${board.boardContent }</textarea></td>
               </tr>
            </table>
            <br>
