...
<body>
	...
	<script>
		...
		window.onload = () =>{
			...
			*/
			...
			function detail(e){
				/*
				consol.log($(e).find('.thumbnail-date').val());
				consol.log($(e).find('.thumbnail-content').val());
				consol.log($(e).find('.thumbnail-img').att());
				consol.log($(e).find('.thumbnail-title').text());
				consol.log($(e).find('.thumbnail-writer').text());
				*/
	...
	<script>
		$('#j-btn').click(() => {
			//document.getElementById("j-input").value='ㅇ';
			//alert(document.getElementById("j-input").value);
			//$('#j-input').val('인자값으로 전달');
			//alert($('#j-input').val());
			//document.getElementById("j-btn").innerHTML='ㅇ';
			...
			<div class="container">
				<div class="row">
					...
					<c:forEach items="${ board}" var="img">
						<div class="col-md-4 col-sm-6 portfolio-item" onclick="func(this);">
							...
							<a class="portfolio-link" data-toggle="modal" href="#MyModal">
								...
								<img class="img-thumbnail img-fluid" src="${ img.changeName}" alt="게시글이미지" class="thumbnail-img">
							</a>
