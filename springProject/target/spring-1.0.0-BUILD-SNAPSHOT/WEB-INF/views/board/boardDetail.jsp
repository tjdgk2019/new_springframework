...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter">
				...
				<tr>
					...
					<c:choose>
						<c:when test="${ empty board.originName }">
							<td colspan="3">파일이 존재하지 않습니다.</td>
						</c:when>
						<c:otherwise>
							<td colspan="3"><a href="${ board.changeName }"
								download="${ board.originName }">${ board.originName }</a></td>
						</c:otherwise>
					</c:choose>
				</tr>
				<tr>
			...
			<div align="center">
				<c:if
					test="${ sessionScope.loginUser.userId eq requestScope.board.boardWriter}">
			...
			<form method="post" action="" id="postForm">
				...
				<input type="hidden" name="filePath" value="${board.changeName }"></input>
			</form>
			<script>
				...
				<c:choose>
				    ...
				    <c:otherwise>
				        <tr>
				            ...
				            <th style="vertical-align: middle">
				                <button onclick="saveReply();" class="btn btn-secondary">등록하기</button>
				            </th>
				        </tr>
				    </c:otherwise>
				</c:choose>
